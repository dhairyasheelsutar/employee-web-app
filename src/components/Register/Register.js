...
class Register extends Component{
    ...
    render(){
        ...
        if(this.props.formSubmitted && this.props.requestFailed === undefined){
            snackbar = <SnackbarApp show={this.props.formSubmitted} message="Saving data"/>
        }else if(this.props.formSubmitted && this.props.requestFailed === false){
            snackbar = <SnackbarApp show={this.props.formSubmitted} message="Data saved successfully"/>
        }else if(this.props.formSubmitted && this.props.requestFailed){
            snackbar = <SnackbarApp show={this.props.formSubmitted} message="Something went wrong"/>
        }
